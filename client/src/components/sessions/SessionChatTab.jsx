...
const SessionChatTab = ({message = []}) => {
    ...
    return (
        <div className='space-y-3'>
             {message.map((msg, idx)=>(
             <div key={idx} className='bg-slate-50 p-3.5 rounded-2xl border
             border-slate-100'>
                   <div className='flex items-center justify-between mb-1'>
                       <span className='text-xs font-semibold text-slate-800'>{msg.senderName}
                       </span>

...
import { AcceptFeedMemberInviteRequest, AcceptFeedMemberInviteResponse, AcceptFollowRequest, AcceptFollowResponse, ActivityFeedbackRequest, ActivityFeedbackResponse, AddActivityRequest, AddActivityResponse, AddBookmarkRequest, AddBookmarkResponse, AddCommentBookmarkRequest, AddCommentBookmarkResponse, AddCommentReactionRequest, AddCommentReactionResponse, AddCommentRequest, AddCommentResponse, AddCommentsBatchRequest, AddCommentsBatchResponse, AddReactionRequest, AddReactionResponse, BatchQueryActivityReactionsRequest, BatchQueryActivityReactionsResponse, BatchQueryCommentReactionsRequest, BatchQueryCommentReactionsResponse, CastPollVoteRequest, ChangeFeedVisibilityRequest, ChangeFeedVisibilityResponse, CreateCollectionsRequest, CreateCollectionsResponse, CreateFeedGroupRequest, CreateFeedGroupResponse, CreateFeedViewRequest, CreateFeedViewResponse, CreateFeedsBatchRequest, CreateFeedsBatchResponse, CreateMembershipLevelRequest, CreateMembershipLevelResponse, DeleteActivitiesRequest, DeleteActivitiesResponse, DeleteActivityReactionResponse, DeleteActivityResponse, DeleteBookmarkFolderResponse, DeleteBookmarkResponse, DeleteCollectionsResponse, DeleteCommentBookmarkResponse, DeleteCommentReactionResponse, DeleteCommentResponse, DeleteFeedGroupResponse, DeleteFeedResponse, DeleteFeedUserDataRequest, DeleteFeedUserDataResponse, DeleteFeedViewResponse, DeleteFeedsBatchRequest, DeleteFeedsBatchResponse, DeleteUserInterestsResponse, ExportFeedUserDataResponse, FollowBatchRequest, FollowBatchResponse, FollowRequest, GetActivityResponse, GetCommentRepliesResponse, GetCommentResponse, GetCommentsResponse, GetFeedCountsResponse, GetFeedGroupResponse, GetFeedViewResponse, GetFeedVisibilityResponse, GetFeedsRateLimitsResponse, GetFollowSuggestionsResponse, GetOrCreateFeedGroupRequest, GetOrCreateFeedGroupResponse, GetOrCreateFeedRequest, GetOrCreateFeedResponse, GetOrCreateFeedViewRequest, GetOrCreateFeedViewResponse, GetOrCreateFollowResponse, GetOrCreateUnfollowRequest, GetOrCreateUnfollowResponse, GetUserInterestsResponse, ListFeedGroupsResponse, ListFeedViewsResponse, ListFeedVisibilitiesResponse, MarkActivityRequest, OwnBatchRequest, OwnBatchResponse, PinActivityRequest, PinActivityResponse, PollVoteResponse, QueryActivitiesRequest, QueryActivitiesResponse, QueryActivityReactionsRequest, QueryActivityReactionsResponse, QueryActivitySharesResponse, QueryBookmarkFoldersRequest, QueryBookmarkFoldersResponse, QueryBookmarksRequest, QueryBookmarksResponse, QueryCollectionsRequest, QueryCollectionsResponse, QueryCommentReactionsRequest, QueryCommentReactionsResponse, QueryCommentsRequest, QueryCommentsResponse, QueryFeedMembersRequest, QueryFeedMembersResponse, QueryFeedsRequest, QueryFeedsResponse, QueryFeedsUsageStatsRequest, QueryFeedsUsageStatsResponse, QueryFollowsRequest, QueryFollowsResponse, QueryMembershipLevelsRequest, QueryMembershipLevelsResponse, QueryPinnedActivitiesRequest, QueryPinnedActivitiesResponse, QueryRevisionHistoryRequest, QueryRevisionHistoryResponse, ReadCollectionsResponse, RejectFeedMemberInviteRequest, RejectFeedMemberInviteResponse, RejectFollowRequest, RejectFollowResponse, Response, RestoreActivityRequest, RestoreActivityResponse, RestoreCommentRequest, RestoreCommentResponse, RestoreFeedGroupResponse, SingleFollowResponse, TrackActivityMetricsRequest, TrackActivityMetricsResponse, TranslateActivityRequest, TranslateActivityResponse, TranslateCommentRequest, TranslateCommentResponse, UnfollowBatchRequest, UnfollowBatchResponse, UnfollowResponse, UnpinActivityResponse, UpdateActivitiesPartialBatchRequest, UpdateActivitiesPartialBatchResponse, UpdateActivityPartialRequest, UpdateActivityPartialResponse, UpdateActivityRequest, UpdateActivityResponse, UpdateBookmarkFolderRequest, UpdateBookmarkFolderResponse, UpdateBookmarkRequest, UpdateBookmarkResponse, UpdateCollectionsRequest, UpdateCollectionsResponse, UpdateCommentBookmarkRequest, UpdateCommentBookmarkResponse, UpdateCommentPartialRequest, UpdateCommentPartialResponse, UpdateCommentRequest, UpdateCommentResponse, UpdateFeedGroupRequest, UpdateFeedGroupResponse, UpdateFeedMembersRequest, UpdateFeedMembersResponse, UpdateFeedRequest, UpdateFeedResponse, UpdateFeedViewRequest, UpdateFeedViewResponse, UpdateFeedVisibilityRequest, UpdateFeedVisibilityResponse, UpdateFollowRequest, UpdateFollowResponse, UpdateMembershipLevelRequest, UpdateMembershipLevelResponse, UpsertActivitiesRequest, UpsertActivitiesResponse, UpsertCollectionsRequest, UpsertCollectionsResponse, UpsertUserInterestsRequest, UpsertUserInterestsResponse } from '../models';
export declare class FeedsApi {
    ...
    updateActivitiesPartialBatch(request: UpdateActivitiesPartialBatchRequest): Promise<StreamResponse<UpdateActivitiesPartialBatchResponse>>;
    deleteActivities(request: DeleteActivitiesRequest): Promise<StreamResponse<DeleteActivitiesResponse>>;
    trackActivityMetrics(request: TrackActivityMetricsRequest): Promise<StreamResponse<TrackActivityMetricsResponse>>;
    queryActivities(request?: QueryActivitiesRequest & {
        language?: string;
        translate_text?: boolean;
    }): Promise<StreamResponse<QueryActivitiesResponse>>;
    batchQueryActivityReactions(request: BatchQueryActivityReactionsRequest): Promise<StreamResponse<BatchQueryActivityReactionsResponse>>;
    ...
    translateActivity(request: TranslateActivityRequest & {
        id: string;
    ...
    queryBookmarks(request?: QueryBookmarksRequest & {
        language?: string;
        translate_text?: boolean;
    ...
    queryCollections(request?: QueryCollectionsRequest): Promise<StreamResponse<QueryCollectionsResponse>>;
    getComments(request: {
        object_id: string;
        object_type: string;
        depth?: number;
    ...
    queryComments(request: QueryCommentsRequest & {
        language?: string;
        translate_text?: boolean;
    }): Promise<StreamResponse<QueryCommentsResponse>>;
    batchQueryCommentReactions(request: BatchQueryCommentReactionsRequest): Promise<StreamResponse<BatchQueryCommentReactionsResponse>>;
    deleteCommentBookmark(request: {
        comment_id: string;
        folder_id?: string;
        user_id?: string;
    }): Promise<StreamResponse<DeleteCommentBookmarkResponse>>;
    updateCommentBookmark(request: UpdateCommentBookmarkRequest & {
        comment_id: string;
    }): Promise<StreamResponse<UpdateCommentBookmarkResponse>>;
    addCommentBookmark(request: AddCommentBookmarkRequest & {
        comment_id: string;
    ...
    updateCommentPartial(request: UpdateCommentPartialRequest & {
        id: string;
    ...
    restoreComment(request: RestoreCommentRequest & {
        id: string;
    }): Promise<StreamResponse<RestoreCommentResponse>>;
    translateComment(request: TranslateCommentRequest & {
        id: string;
    ...
    getOrCreateFollow(request: FollowRequest): Promise<StreamResponse<GetOrCreateFollowResponse>>;
    unfollow(request: {
        source: string;
        target: string;
        delete_notification_activity?: boolean;
    ...
    queryRevisionHistory(request: QueryRevisionHistoryRequest): Promise<StreamResponse<QueryRevisionHistoryResponse>>;
    ...
    getOrCreateUnfollow(request: GetOrCreateUnfollowRequest): Promise<StreamResponse<GetOrCreateUnfollowResponse>>;
    ...
    deleteUserInterests(request: {
        user_id: string;
        tags: Array<string>;
    }): Promise<StreamResponse<DeleteUserInterestsResponse>>;
    getUserInterests(request: {
        user_id: string;
        limit?: number;
    }): Promise<StreamResponse<GetUserInterestsResponse>>;
    upsertUserInterests(request: UpsertUserInterestsRequest & {
        user_id: string;

...
export interface BlockListRule {
    action: 'flag' | 'mask' | 'mask_flag' | 'shadow' | 'remove' | 'bounce' | 'bounce_flag' | 'bounce_remove';
    name?: string;
    team?: string;
}
...
export interface BodyguardRule {
    label: string;
    action?: 'keep' | 'flag' | 'mask' | 'mask_flag' | 'shadow' | 'remove' | 'bounce' | 'bounce_flag' | 'bounce_remove';
    severity_rules?: Array<BodyguardSeverityRule>;
}
export interface BodyguardSeverityRule {
    action: 'keep' | 'flag' | 'mask' | 'shadow' | 'remove' | 'bounce' | 'bounce_flag' | 'bounce_remove';
...
export interface ChannelBatchUpdateRequest {
    operation: 'addMembers' | 'addMembersHideHistory' | 'removeMembers' | 'inviteMembers' | 'invites' | 'assignRoles' | 'addModerators' | 'demoteModerators' | 'hide' | 'show' | 'archive' | 'unarchive' | 'updateData';
    /**
...
export declare const ChannelOwnCapability: {
    ...
    readonly CREATE_MENTION: "create-mention";
    ...
    readonly NOTIFY_CHANNEL: "notify-channel";
    readonly NOTIFY_GROUP: "notify-group";
    readonly NOTIFY_HERE: "notify-here";
    readonly NOTIFY_ROLE: "notify-role";
...
export interface SubmitActionRequest {
     ...
     */
    action_type: 'flag' | 'mark_reviewed' | 'delete_message' | 'delete_activity' | 'delete_comment' | 'delete_reaction' | 'ban' | 'custom' | 'unban' | 'restore' | 'delete_user' | 'delete_user_messages' | 'unblock' | 'block' | 'shadow_block' | 'unmask' | 'kick_user' | 'end_call' | 'reject_appeal' | 'escalate' | 'de_escalate' | 'bypass';
    /**
...
export interface UpsertPushPreferencesResponse {
     ...
     */
    user_channel_preferences: Record<string, Record<string, ChannelPushPreferencesResponse>>;
    /**
...
export type WHEvent = ({
    ...
    type: 'export.review_queue.error';
} & AsyncExportErrorEvent) | ({
    type: 'export.review_queue.success';
    ...
    type: 'moderation.analysis.failed';

...
export declare class StreamClient extends CommonApi {
    ...
    upsertUsers: (users: UserRequest[]) => Promise<import("./types").StreamResponse<import("..").UpdateUsersResponse>>;
    queryBannedUsers: (request?: {
        payload?: QueryBannedUsersPayload;
    }) => Promise<import("./types").StreamResponse<import("..").QueryBannedUsersResponse>>;
    uploadFile: (request: Omit<FileUploadRequest, "file"> & {
        file: File;
    }) => Promise<import("./types").StreamResponse<import("..").FileUploadResponse>>;
    uploadImage: (request: Omit<ImageUploadRequest, "file"> & {
        file: File;
    }) => Promise<import("./types").StreamResponse<import("..").ImageUploadResponse>>;
    /**
     *
     * @param payload
     ...
     */
    verifyAndParseWebhook: (rawBody: string | Buffer, signature: string) => import("..").WHEvent;
    /**
     ...
     */
    parseSqs: (messageBody: string) => import("..").WHEvent;
    /**
     ...
     */
    parseSns: (notificationBody: string) => import("..").WHEvent;
}
